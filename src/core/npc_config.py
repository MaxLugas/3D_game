...
DROID_AVOID_SPACING = 0.9                        # Расстояние между лучами обхода | Ray spacing for avoidance
DROID_AVOID_STRENGTH = 2.0                       # Сила уклонения от препятствий | Obstacle avoidance strength
DROID_MODELS = ("Droid.bam",)                    # Имена моделей дроидов в map.json | Droid model names in map.json